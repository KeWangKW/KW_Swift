...
//
//  Created by Sven on 2021/2/22.
//

// https://github.com/CodeOcenS/TextEditorView
...
typealias  TextEditorViewStrClick = (String) ->()
open class TextEditorView: UIView {
    var StrBlock : BlockStrClick?
    func strClick(jumpbtnClickBlock:@escaping BlockStrClick) -> Void {
