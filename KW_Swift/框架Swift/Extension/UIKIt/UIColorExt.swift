...
public extension UIColor {
    ...
    @objc static var Title: UIColor {
        return .custom(.title)
    }
    
    @objc static var Content: UIColor {
        return .custom(.content)
    }
    
    @objc static var Assist: UIColor {
        return .custom(.assist)
    }
    
    @objc static var Base: UIColor {
        return .custom(.base)
    }
    
    @objc static var Section: UIColor {
    ...
    @objc static func HexColor(str:NSString) ->UIColor {
        return UIColor(hexString: str as String)
    }
