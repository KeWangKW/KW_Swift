...
public extension KWSwiftWrapper where Base: UICollectionView {
    func registerXib(cell: AnyClass) {
        base.register(UINib.init(nibName: NSStringFromClass(cell), bundle: nil), forCellWithReuseIdentifier: NSStringFromClass(cell))
    }
    func registerXib2(cell: AnyClass) { //collectionCell
